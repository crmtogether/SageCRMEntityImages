...
if (Key0==1) {
    ...
    images.useRef = "Ref:"+ myRecord("Case_ReferenceId");
    ...
    images.useRef = "Ref:"+ myRecord("orde_reference");
...
Response.Write('{"companyImageUrl": "'+images.companyImageUrl+'","compName":"'+myEscape(images.compName)+'" ,"personImageUrl":"'+images.personImageUrl+'","persName":"'+images.persName+'", "useRef":"'+images.useRef+'"}');
Response.End();
